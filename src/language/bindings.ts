...
export const BINDING_KIND_SPECS: Record<BindingKind, BindingKindSpec> = {
...
// Import resource kinds currently map directly to binding kinds, but this
// helper keeps parser/semantic code decoupled if those names diverge later.
