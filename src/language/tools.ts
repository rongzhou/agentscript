import { OPTIMIZER_SCHEME, MCP_SCHEME, NODE_SCHEME, NPM_SCHEME } from "./schemes.js";
...
function isOptimizerToolUri(uri: string | undefined): boolean {
