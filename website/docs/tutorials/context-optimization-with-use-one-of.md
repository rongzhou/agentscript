...
Full source: [`../../../tutorials/use-one-of.as`](https://github.com/rongzhou/agentscript/blob/main/tutorials/use-one-of.as)
...
- [`../optimizer.md`](https://github.com/rongzhou/agentscript/blob/main/docs/en/optimizer.md)
