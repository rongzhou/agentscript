...
- [Optimizer Toolchain](./optimizer.md)：用于 inspect、trial 和 specialize `use one of` 变体的 `host://agentscript` 工具。
...
| `host://agentscript` | 内置 optimizer toolchain | `host://agentscript` |
