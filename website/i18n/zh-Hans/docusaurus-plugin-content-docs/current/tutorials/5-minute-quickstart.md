...
- 阅读语言参考：[`../language.md`](https://github.com/rongzhou/agentscript/blob/main/docs/cn/language.md)
- 学习显式上下文选择：[`../use-as.md`](https://github.com/rongzhou/agentscript/blob/main/docs/cn/use-as.md)
- 尝试结构化并行：[`../parallel-for.md`](https://github.com/rongzhou/agentscript/blob/main/docs/cn/parallel-for.md)
